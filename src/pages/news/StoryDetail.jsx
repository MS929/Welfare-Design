  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        ...
        <hr className="my-8 md:my-10 border-t-2 border-transparent bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 h-[2px] rounded-full" />
        ...
        <nav className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-3">
          {neighbors.prev ? (
            <button
              ...
              className="text-left rounded-xl border border-gray-200 px-4 py-3 hover:bg-gray-50"
            >
              <div className="text-xs text-gray-500">이전 글</div>
              <div className="font-semibold text-gray-800 line-clamp-1">{neighbors.prev.title}</div>
            </button>
          ) : <div />}
          {neighbors.next ? (
            <button
              onClick={() => nav(`/news/stories/${neighbors.next.slug}`, { state: { tab: effectiveTab, backTo } })}
              className="text-right rounded-xl border border-gray-200 px-4 py-3 hover:bg-gray-50"
            >
              <div className="text-xs text-gray-500">다음 글</div>
              <div className="font-semibold text-gray-800 line-clamp-1">{neighbors.next.title}</div>
            </button>
          ) : <div />}
        </nav>
      </div>
