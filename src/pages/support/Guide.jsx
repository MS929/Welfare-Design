...
function CardSection({ title, rightSlot, children, className = "" }) {
  return (
    <div className={`rounded-2xl border bg-white ${className}`}>
      <div className="px-6 py-5 border-b border-emerald-200/50 flex items-center justify-between">
...
function BankBox({ className = "" }) {
  ...
  return (
    <section className={`max-w-screen-xl mx-auto px-4 mt-10`}>
      <CardSection title="무통장 입금(계좌이체)" rightSlot={copyButton}>
