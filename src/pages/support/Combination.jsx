export default function Combination() {
  return (
    <div className="max-w-[880px] mx-auto px-5 pt-8 pb-20">
      <section>
        <div className="mb-10">
          <div className="text-sm text-gray-400 mb-2 invisible">사업 &gt; 조합 가입</div>
          <h1 className="font-extrabold text-3xl text-[#111827] mb-4 leading-tight">조합 가입</h1>
          <p className="text-gray-700 leading-relaxed max-w-[760px] mb-2">
