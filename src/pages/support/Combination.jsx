export default function Combination() {
  return (
    <div className="max-w-[880px] mx-auto px-5 pt-6 pb-20">
      <section>
        <div className="mb-10">
          <h1 className="font-extrabold text-2xl text-[#111827] mb-3 leading-tight">조합 가입</h1>
          <p className="text-gray-700 leading-relaxed max-w-[760px] mb-6">
