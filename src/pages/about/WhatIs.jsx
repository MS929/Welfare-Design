...
export default function AboutWhat() {
  ...
  const principles = [
    ...
    },
    {
      no: "02.",
      title: "민주적 운영",
      desc: "조합원에 의해 민주적으로 운영되며, 1인 1표의 원칙을 지킵니다.",
    },
    {
      no: "03.",
      title: "경제적 참여",
      desc: "조합원은 출자·이용·참여를 통해 조합의 자립 기반을 함께 만듭니다.",
    },
    {
      no: "04.",
      title: "자율과 독립",
      desc: "공공·민간과 협력하되 조합의 정체성과 독립성을 유지합니다.",
    },
    {
      no: "05.",
      title: "교육·훈련·정보 제공",
      desc: "조합원·활동가·지역주민에게 필요한 학습과 정보를 제공합니다.",
    },
    {
      no: "06.",
      title: "협동조합 간의 협동",
      desc: "지역·국내·국제 협동조합과 연대해 상호 학습·교류를 촉진합니다.",
    },
    {
      no: "07.",
      title: "지역사회 기여",
      desc: "지역의 필요에 기반한 사업을 통해 지속가능한 변화를 추구합니다.",
    },
  ];
