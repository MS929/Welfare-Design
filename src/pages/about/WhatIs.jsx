...
export default function AboutWhat() {
  ...
  const background = {
    ...
    paragraphs: [
      ...
      "이제 그 경험과 사명을 지역사회와 이웃에게 돌려드리고자, 함께 조합을 출범하게 되었습니다.",
      "조합의 이름에는 두 가지 신념이 담겨 있습니다.",
      "첫째, 복지는 설계할 수 있다는 믿음입니다. 작고 연약한 삶도 따뜻하게 디자인될 수 있습니다.",
      "둘째, 우리가 추구하는 복지는 단순한 서비스가 아니라, 의미와 책임, 그리고 소명을 담은 복지입니다.",
      "복지디자인 사회적협동조합은 은혜의 복지를 기획하고, 사람을 향한 섬김을 실천하며, 지속가능하고 따뜻한 공동체를 만들어가고자 합니다.",
