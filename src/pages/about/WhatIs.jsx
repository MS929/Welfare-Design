...
export default function AboutWhat() {
  ...
  const background = {
    ...
    paragraphs: [
      "복지디자인 사회적협동조합은 한국침례신학대학교 사회복지대학원에서 만난 12명의 동문들이 사람을 향한 마음을 배우고 사회복지의 가치를 실천해온 경험을\n지역사회와 이웃에게 돌려드리고자 설립한 조합입니다.",
    ...
    <div className="bg-white">
      ...
      <section className="max-w-screen-xl mx-auto px-4 pt-10">
        <nav className="text-sm text-brand-700/80">
          소개 &gt; <span className="text-black-700">복지디자인은?</span>
        </nav>
