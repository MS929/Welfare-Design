// -----------------------------------------------------------------------------
// [페이지 목적]
//  - 복지디자인 사회적협동조합의 설립 배경과 비전을 소개하는 인사말 페이지
//
// [콘텐츠 특성]
//  - 긴 문단 중심의 정적 텍스트 콘텐츠
//  - 읽기 흐름과 가독성을 최우선으로 고려한 타이포그래피 중심 구성
//
// [디자인/UX 기준]
//  - 모바일/태블릿/데스크톱에서 동일한 읽기 경험을 제공
//  - 줄 길이(ch 단위), 행간, 줄바꿈 규칙을 통해 독서 피로도 최소화
// -----------------------------------------------------------------------------
  ...
  return (
    <>
      {/* 페이지 전용 텍스트 가독성 보정 스타일
          - 줄바꿈 규칙, 자간, 폰트 스무딩을 한 곳에서 관리
          - 긴 문단 위주의 콘텐츠에서 모바일 가독성을 안정적으로 유지하기 위함 */}
      <style
        id="page-text-guard"
...
.u-ellipsis { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
      ...
      <div className="bg-white relative overflow-hidden">
        ...
        {/* 본문 영역: 긴 텍스트 콘텐츠를 위한 가독성 중심 레이아웃 */}
        <section className="px-4 sm:px-5 md:px-6 pb-16">
          ...
          >
            ...
            <blockquote className="text-left text-gray-700 italic tracking-tight text-[clamp(16px,4.2vw,20px)] leading-[1.75] sm:leading-[1.8] md:leading-[1.85]">
              {" "}
              “사람을 향한 사랑의 마음으로, 복지를 디자인하는 따뜻한 연결을
              시작합니다.”
            </blockquote>
            <div className="mt-4 mb-8 h-[3px] w-14 rounded-full bg-[#3BA7A0]/35" />
            {/* 인사말 본문 문단
              - 문단 간 충분한 간격과 line-height로 편안한 읽기 경험 제공 */}
            <div className="space-y-8 text-gray-800 text-[clamp(15px,3.9vw,17.5px)] leading-[1.75] sm:leading-[1.85] md:leading-[1.9]">
              <p>
