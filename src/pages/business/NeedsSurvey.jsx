...
export default function NeedsSurvey() {
  return (
    <BizLayout title="취약 계층 복지욕구 실태조사">
      <div className="max-w-screen-xl mx-auto px-4 pb-8 md:pb-0">
        ...
        <div className="grid gap-8 md:grid-cols-2 items-stretch">
          ...
          <div className="grid md:h-[440px] lg:h-[470px] grid-rows-[auto,1fr,auto] gap-6 mt-14">
            ...
            <div className="mt-4 mb-2 md:mb-0">
              ...
              <div className="md:hidden rounded-2xl border border-[#F26C2A]/45 bg-gradient-to-r from-[#FFF3E9] to-[#EFFFFD] px-5 py-3 shadow-md">
