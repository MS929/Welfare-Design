  ...
  return (
    <BizLayout title="복지용구 신청 안내 지원">
      <div className="max-w-screen-xl mx-auto px-4">
        {/* 상단: 좌측 이미지 / 우측 안내 박스 */}
        <div className="grid md:grid-cols-2 gap-8 items-stretch min-h-[560px]">
          {/* 이미지 */}
          <div className="rounded-2xl bg-emerald-50 p-4 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.05)] flex items-center justify-center overflow-hidden min-h-[560px]">
            <img
              ...
              alt="복지용구 신청 안내 지원"
              className="h-full w-auto max-w-full max-h-full object-contain rounded-xl"
            />
          </div>
          ...
          <div className="flex flex-col gap-6 h-full">
            ...
            {/* 상담 문의 배너 */}
            <div className="rounded-xl border border-emerald-300 bg-emerald-50 px-6 py-4 shadow-sm">
              <div className="flex items-center justify-center gap-3 text-emerald-900 text-base md:text-lg">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-emerald-700" aria-hidden="true">
                ...
                <span className="font-extrabold text-xl md:text-2xl tabular-nums text-emerald-900">042-000-0000</span>
              </div>
            </div>
          </div>
        </div>
