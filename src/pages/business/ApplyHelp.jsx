    ...
    <BizLayout title="복지용구 신청 안내 지원">
      <div className="max-w-screen-xl mx-auto px-4">
        ...
        <div className="grid gap-8 md:grid-cols-2 items-stretch">
          ...
          <div className="grid h-[440px] lg:h-[500px] grid-rows-[auto,1fr,auto] gap-6">
            {/* 안내 박스 */}
            ...
            {/* 기대 효과 */}
            <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-8 h-full">
            ...
            {/* 상담 문의 배너 */}
            <div className="rounded-xl border border-emerald-300 bg-emerald-50/70 px-8 py-6 shadow-sm">
