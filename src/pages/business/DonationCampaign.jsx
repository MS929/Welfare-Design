        ...
        <div className="grid gap-8 md:grid-cols-2 items-stretch">
          ...
          <div className="flex flex-col h-full">
            <div className="flex flex-col h-full justify-between">
              <div className="rounded-xl border border-emerald-200 bg-white shadow-sm p-6 h-full">
              ...
              <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-6 mt-6 h-full">
