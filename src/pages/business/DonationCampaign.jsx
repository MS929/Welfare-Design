      ...
      <div className="max-w-screen-xl mx-auto px-4 pb-24 md:pb-0">
        ...
        <div className="grid gap-8 md:grid-cols-2 items-stretch">
          ...
          <div className="grid gap-6 mt-10 md:mt-14 md:grid-rows-[auto,1fr,auto] md:h-[470px] md:max-h-none">
            ...
            <div className="rounded-2xl border border-[#F26C2A]/45 bg-gradient-to-r from-[#FFF3E9] to-[#EFFFFD] px-6 py-4 md:px-8 md:py-5 shadow-md">
              <div className="flex items-center gap-3 md:gap-4 min-w-0 whitespace-nowrap">
                <svg
                ...
                <span className="font-semibold tracking-wide text-[#374151] truncate min-w-0">
                  신청 문의 : 복지디자인
                </span>
                <a
                  href="tel:0420000000"
                  className="ml-auto font-extrabold text-[18px] md:text-2xl tabular-nums text-[#F26C2A] underline whitespace-nowrap"
                >
                  042-000-0000
                </a>
              </div>
