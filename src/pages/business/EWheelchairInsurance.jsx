      ...
      <div className="max-w-screen-xl mx-auto px-4 pb-24 md:pb-0">
        ...
        <div className="grid gap-8 md:grid-cols-2 items-stretch">
          ...
          <div className="grid md:h-[440px] lg:h-[470px] grid-rows-[auto,1fr,auto] gap-6 mt-14">
            ...
            <div className="block md:hidden rounded-2xl border border-[#F26C2A]/45 bg-gradient-to-r from-[#FFF3E9] to-[#EFFFFD] px-5 py-4 shadow-md mb-16">
              <div className="flex items-center justify-between gap-3 text-[#111827] tracking-tight">
                {/* phone icon */}
                <svg
                ...
                <span className="font-semibold tracking-wide text-[#374151] text-sm whitespace-nowrap">
                  신청 문의 : 복지디자인
                </span>
                <a href="tel:0420000000" className="font-extrabold text-lg tabular-nums text-[#F26C2A] underline whitespace-nowrap">
                  042-000-0000
                </a>
              </div>
            </div>

            <div className="hidden md:block rounded-2xl border border-[#F26C2A]/45 bg-gradient-to-r from-[#FFF3E9] to-[#EFFFFD] px-8 py-5 shadow-md md:mb-0">
