// -----------------------------------------------------------------------------
// EWheelchairInsurance.jsx
// [페이지 목적]
//  - 취약 계층 복지욕구 실태조사 안내 페이지
//  - 실태조사 안내 이미지를 중심으로 정보를 전달하는 단일 이미지형 페이지
//
// [화면 구성]
//  - BizLayout 공통 사업 레이아웃 사용
//  - 본문: 취약 계층 복지욕구 실태조사 안내 이미지 표시
//
// [이미지 처리]
//  - public/images/business/needs-survey.png 정적 이미지 사용
//  - 중요한 안내 이미지이므로 eager/high 옵션으로 우선 로딩
//  - Cloudinary image/fetch 변환은 사용하지 않음
//
// [유지보수 위치]
//  - 안내 이미지 변경: public/images/business/needs-survey.png 교체
...
export default function EwcInsurance() {
  const IMAGE_SRC = "/images/business/needs-survey.png?v=20260522-ewc";
