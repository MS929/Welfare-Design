...
export default function Navbar() {
  ...
  return (
    ...
    >
      <nav className="max-w-[950px] mx-auto relative px-4 md:px-4 py-3 grid grid-cols-[auto,1fr,auto] items-center gap-6">
      ...
      {megaOpen && (
        ...
        >
          <div className="max-w-[750px] mr-auto -ml-3 pl-8 pr-4">
